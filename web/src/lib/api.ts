    ...
    if (mode === "demo") {
        return {
            state: {
                ...
                diagnostics: MOCK_METRICS.diagnostics ?? [],
                correlation_matrix: MOCK_METRICS.correlation_matrix ?? null,
                ...
                attribution_summary: MOCK_METRICS.attribution_summary ?? null,
                attribution_timeseries: MOCK_METRICS.attribution_timeseries ?? [],
                risk_contribution: MOCK_METRICS.risk_contribution ?? { summary: {}, contributions: [] },
                rolling_metrics: MOCK_METRICS.rolling_metrics ?? [],
                macro_regimes: MOCK_METRICS.macro_regimes ?? [],
                macro: MOCK_METRICS.macro ?? { status: "unavailable", missing_series: [], as_of: null, flags: [] },
                benchmark_comparison: MOCK_METRICS.benchmark_comparison ?? null,
                benchmark_timeseries: MOCK_METRICS.benchmark_timeseries ?? [],
                risk_free_series: MOCK_METRICS.risk_free_series ?? [],
                corporate_actions: MOCK_METRICS.corporate_actions ?? [],
                data_contracts: MOCK_METRICS.data_contracts ?? {},
